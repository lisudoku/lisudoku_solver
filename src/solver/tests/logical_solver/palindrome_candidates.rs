use crate::{solver::{logical_solver::{candidates::Candidates, palindrome_candidates::PalindromeCandidates, technique::Technique}, Solver}, types::{Area, CellPosition, FixedNumber, Rule, SudokuConstraints}};
