use crate::{types::{SudokuConstraints, CellPosition, SolutionType, KillerCage}, solver::Solver};
...
fn check_killer_9x9_2_solve() {
  ...
  constraints.killer_cages = vec![
    ...
    KillerCage {
      sum: Some(14),
      region: vec![ CellPosition::new(0, 5), CellPosition::new(0, 6), CellPosition::new(0, 7) ],
    },
    KillerCage {
      sum: Some(16),
      region: vec![ CellPosition::new(0, 8), CellPosition::new(1, 8) ],
    },
    KillerCage {
      sum: Some(17),
      region: vec![ CellPosition::new(1, 0), CellPosition::new(2, 0) ],
    },
    KillerCage {
      sum: Some(6),
      region: vec![ CellPosition::new(1, 1), CellPosition::new(2, 1) ],
    },
    KillerCage {
      sum: Some(17),
      region: vec![ CellPosition::new(1, 2), CellPosition::new(2, 2), CellPosition::new(3, 2) ],
    },
    KillerCage {
      sum: Some(16),
      region: vec![ CellPosition::new(1, 3), CellPosition::new(2, 3), CellPosition::new(3, 3) ],
    },
    KillerCage {
      sum: Some(4),
      region: vec![ CellPosition::new(1, 4), CellPosition::new(2, 4) ],
    },
    KillerCage {
      sum: Some(12),
      region: vec![ CellPosition::new(1, 5), CellPosition::new(1, 6), CellPosition::new(1, 7) ],
    },
    KillerCage {
      sum: Some(16),
      region: vec![ CellPosition::new(2, 5), CellPosition::new(2, 6), CellPosition::new(2, 7) ],
    },
    KillerCage {
      sum: Some(9),
      region: vec![ CellPosition::new(2, 8), CellPosition::new(3, 8) ],
    },
    KillerCage {
      sum: Some(4),
      region: vec![ CellPosition::new(3, 0), CellPosition::new(3, 1) ],
    },
    KillerCage {
      sum: Some(23),
      region: vec![ CellPosition::new(3, 5), CellPosition::new(3, 6), CellPosition::new(3, 7) ],
    },
    KillerCage {
      sum: Some(15),
      region: vec![ CellPosition::new(4, 0), CellPosition::new(4, 1), CellPosition::new(4, 2) ],
    },
    KillerCage {
      sum: Some(16),
      region: vec![ CellPosition::new(4, 6), CellPosition::new(4, 7), CellPosition::new(4, 8) ],
    },
    KillerCage {
      sum: Some(21),
      region: vec![
    ...
    KillerCage {
      sum: Some(9),
      region: vec![ CellPosition::new(5, 0), CellPosition::new(6, 0) ],
    },
    KillerCage {
      sum: Some(24),
      region: vec![ CellPosition::new(5, 1), CellPosition::new(5, 2), CellPosition::new(5, 3) ],
    },
    KillerCage {
      sum: Some(9),
      region: vec![ CellPosition::new(5, 5), CellPosition::new(6, 5), CellPosition::new(7, 5) ],
    },
    KillerCage {
      sum: Some(14),
      region: vec![ CellPosition::new(5, 6), CellPosition::new(6, 6), CellPosition::new(7, 6) ],
    },
    KillerCage {
      sum: Some(6),
      region: vec![ CellPosition::new(5, 7), CellPosition::new(5, 8) ],
    },
    KillerCage {
      sum: Some(7),
      region: vec![ CellPosition::new(6, 1), CellPosition::new(6, 2), CellPosition::new(6, 3) ],
    },
    KillerCage {
      sum: Some(17),
      region: vec![ CellPosition::new(6, 4), CellPosition::new(7, 4) ],
    },
    KillerCage {
      sum: Some(12),
      region: vec![ CellPosition::new(6, 7), CellPosition::new(7, 7) ],
    },
    KillerCage {
      sum: Some(14),
      region: vec![ CellPosition::new(6, 8), CellPosition::new(7, 8) ],
    },
    KillerCage {
      sum: Some(12),
      region: vec![ CellPosition::new(7, 0), CellPosition::new(8, 0) ],
    },
    KillerCage {
      sum: Some(11),
      region: vec![ CellPosition::new(7, 1), CellPosition::new(7, 2), CellPosition::new(7, 3) ],
    },
    KillerCage {
      sum: Some(23),
      region: vec![ CellPosition::new(8, 1), CellPosition::new(8, 2), CellPosition::new(8, 3) ],
    },
    KillerCage {
      sum: Some(13),
      region: vec![ CellPosition::new(8, 4), CellPosition::new(8, 5), CellPosition::new(8, 6) ],
    },
    KillerCage {
      sum: Some(4),
      region: vec![ CellPosition::new(8, 7), CellPosition::new(8, 8) ],
    },
  ];
  let mut solver = Solver::new(constraints, None);
  let result = solver.logical_solve();
